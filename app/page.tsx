...
export default function Home() {
  ...
  const generate = async () => {
    ...
    const clientRequest = { prompt, ratio, outputWidth, outputHeight, imageArea, resolution, advanced, interactionMode, image: interactionMode === "coordinate" ? canvasSource : exportMarkedImage(), referenceImages, coordinateTokens: interactionMode === "coordinate" ? buildCoordinateTokens() : [], markInstructions, debug: debugEnabled };
